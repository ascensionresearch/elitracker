  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        ...
        {isUnlocked ? (
          // When unlocked: Forms at top, data below
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Input Form */}
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-lg p-6 transition-opacity duration-300">
          ...
          // When locked: Data first, forms at bottom
          <div className="space-y-6">
                    ...
                    <div className="relative overflow-x-auto">
                      ...
                      <div className="relative h-64 ml-16 mr-8 mt-8 mb-8" style={{ minWidth: `${Math.max(getDailyHourlyData().length * 80, 400)}px` }}>
                        ...
                        <div className="absolute -bottom-8 left-0 right-0 flex justify-between text-xs text-gray-500">
                          {getDailyHourlyData().map((data) => {
                            const x = (getDailyHourlyData().indexOf(data) / (getDailyHourlyData().length - 1)) * 90 + 5;
                            return (
                              <div
                                key={data.date}
                                className="absolute transform -translate-x-1/2 text-center whitespace-nowrap"
            ...
            {/* Forms at bottom when locked */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Input Form */}
              <div className="lg:col-span-1">
                <div className="bg-white rounded-xl shadow-lg p-6 transition-opacity duration-300 opacity-50 pointer-events-none">
                  <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                    Add Urine Output New Entry
                  </h2>
                ...
                {/* Dressing Change Form */}
                <div className="bg-white rounded-xl shadow-lg p-6 mt-6 transition-opacity duration-300 opacity-50 pointer-events-none">
                  <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                    Add New Dressing Change Entry
                  </h2>
                      ...
                      <div className="space-y-2">
                        <label className="flex items-center">
                          <input
                            ...
                            onChange={(e) => setDressingFormData({
                              ...dressingFormData,
                              drainageTypes: { ...dressingFormData.drainageTypes, urine: e.target.checked }
                            })}
                            className="mr-2"
                            disabled={true}
                          />
                        ...
                        <label className="flex items-center">
                          <input
                            ...
                            onChange={(e) => setDressingFormData({
                              ...dressingFormData,
                              drainageTypes: { ...dressingFormData.drainageTypes, serosanguinousFluid: e.target.checked }
                            })}
                            className="mr-2"
                            disabled={true}
                          />
                        ...
                        <label className="flex items-center">
                          <input
                            ...
                            onChange={(e) => setDressingFormData({
                              ...dressingFormData,
                              drainageTypes: { ...dressingFormData.drainageTypes, purulentDrainage: e.target.checked }
                            })}
                            className="mr-2"
                            disabled={true}
                          />
                        ...
                        <label className="flex items-center">
                          <input
                            ...
                            onChange={(e) => setDressingFormData({
                              ...dressingFormData,
                              drainageTypes: { ...dressingFormData.drainageTypes, serousDrainage: e.target.checked }
                            })}
                            className="mr-2"
                            disabled={true}
                          />
